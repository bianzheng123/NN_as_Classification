...
if __name__ == '__main__':
    ds_fname = 'siftsmall'
    base_config_dir = '/home/zhengbian/NN_as_Classification/config/nn_classification/%s/' % ds_fname
    long_config_dir = base_config_dir + 'long_term_config.json'

    # short_config_fname_arr = ['1_hnsw_16', '1_kmeans_independent_16', '1_kmeans_multiple_16', '1_knn_16', '1_random_16']
    # short_config_fname_arr = ['8_hnsw_16', '8_kmeans_independent_16', '8_kmeans_multiple_16', '8_knn_16', '8_random_16']
    # short_config_fname_arr = ['1_random_16']
    # short_config_fname_arr = ['1_random_16', '8_random_16']
