...
def run_nohup(long_config_dir, short_config_dir, fname):
    os.system(
        'nohup python3 run_counting_index.py --long_term_config_dir %s --short_term_config_dir %s > '
        './log/%s_counting_index.log 2>&1 &' % (
            long_config_dir, short_config_dir, fname))


def run_frontend(long_config_dir, short_config_dir):
    os.system('python3 run_counting_index.py --long_term_config_dir %s --short_term_config_dir %s' % (
        long_config_dir, short_config_dir))


if __name__ == '__main__':
    # base_config_dir = '/home/bz/NN_as_Classification/config/run_2/specific_config/siftsmall/'
    base_config_dir = '/home/bz/NN_as_Classification/config/counting_index/run_2/specific_config/siftsmall/'
