...
def run_nohup(long_config_dir, short_config_dir, fname):
    os.system('nohup python3 run.py --long_term_config_dir %s --short_term_config_dir %s > ./log/%s.log 2>&1 &' % (
...
if __name__ == '__main__':
    base_config_dir = '/home/bz/NN_as_Classification/config/nn_classification/run_2/specific_config/siftsmall/'
