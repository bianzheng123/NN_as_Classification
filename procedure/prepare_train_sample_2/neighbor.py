...
class NeighborDataNode(base_data_node.BaseDataNode):
    ...
    def __init__(self, config):
        ...
        # self.type, self.save_dir, self.classifier_number, self.output_type
    ...
    def prepare(self, base, partition_info):
        print('start prepare data %s_%d %s' % (self.type, self.classifier_number, self.output_type))
        # self.datanode
        ...
        print('finish prepare_data %s_%d %s' % (self.type, self.classifier_number, self.output_type))
